class Prompts:
    ...
    skepticism_refinement_prompt = "Improve the accuracy and elaborate B's response towards person A, based on analyst's feedback. Provide only the improved and elaborated response between [[[ and ]]]"
    simple_skepticism_prompt = "Person B may provide entirely incorrect and impossible information. Identify every suspicious claim. Be highly skeptical. Explain all major and minor problems with person B's response to person A: "
    helpful_character_prompt = "an all-knowing divine committee"
    pre_prompt = """
